plot4<-function(){
        ...
        select$r<-select$Global_reactive_power
        select$v<-select$Voltage
        select$a<-select$Global_active_power
        ...
        plot(select$y, select$a, ylab="Global Active Power (kilowatts)", xlab="", type='l')
        
        plot(select$y, select$v, ylab="Voltage", xlab="datetime", type='l')
        ...
        plot(select$y, select$r, ylab="Global_reactive_power", xlab="datetime", type='l')
